...
exports.convertRgbColorToColor = exports.convertRenpyColorToColor = exports.convertHtmlToColor = exports.convertColorToRgbTuple = exports.convertRgbToHex = exports.findColorMatches = exports.getColorPresentations = exports.getColorInformation = void 0;
...
function getColorPresentations(color, document, range) {
    ...
    if (colorLabel.length > 0) {
        let rgbColorPres = new vscode_1.ColorPresentation(colorLabel);
