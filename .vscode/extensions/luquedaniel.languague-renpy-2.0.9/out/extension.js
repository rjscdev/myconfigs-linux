...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let hoverProvider = vscode_1.languages.registerHoverProvider('renpy', new (class {
        ...
        let definitionProvider = vscode_1.languages.registerDefinitionProvider('renpy', new (class {
        ...
        let symbolProvider = vscode_1.languages.registerDocumentSymbolProvider('renpy', new (class {
        ...
        let signatureProvider = vscode_1.languages.registerSignatureHelpProvider('renpy', new (class {
        ...
        // Completion provider
        let completionProvider = vscode_1.languages.registerCompletionItemProvider('renpy', new (class {
        ...
        // Color Provider
        let colorProvider = vscode_1.languages.registerColorProvider('renpy', new (class {
            provideDocumentColors(document, token) {
                return (0, color_1.getColorInformation)(document);
            }
            provideColorPresentations(color, context, token) {
                return (0, color_1.getColorPresentations)(color, context.document, context.range);
            }
        })());
        context.subscriptions.push(colorProvider);
        // Find All References provider
        let references = vscode_1.languages.registerReferenceProvider('renpy', new (class {
        ...
        let semanticTokens = vscode_1.languages.registerDocumentSemanticTokensProvider('renpy', new (class {
        ...
        let refreshCommand = vscode_1.commands.registerCommand('renpy.refreshNavigationData', () => __awaiter(this, void 0, void 0, function* () {
        ...
        let gotoFileLocationCommand = vscode_1.commands.registerCommand('renpy.jumpToFileLocation', (args) => {
        ...
        let refreshDiagnosticsCommand = vscode_1.commands.registerCommand('renpy.refreshDiagnostics', () => {
        ...
        let compileCommand = vscode_1.commands.registerCommand('renpy.compileNavigationData', () => {
...
function hideRpycFilesFromWorkspace() {
    var jsonDumpFile = (0, workspace_1.getNavigationJsonFilepath)();
    if (fs.existsSync(jsonDumpFile)) {
        const config = vscode_1.workspace.getConfiguration("files");
        if (config["exclude"]["**/*.rpyc"] === undefined) {
            config.update("exclude", { "**/*.rpyc": true }, vscode_1.ConfigurationTarget.Workspace);
        }
    }
}
...
function ExecuteRenpyCompile() {
    ...
    if (isValidExecutable(renpy)) {
        let renpyPath = (0, workspace_1.cleanUpPath)(vscode_1.Uri.file(renpy).path);
